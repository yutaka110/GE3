...
//#include "Math/MathUtils.h"          // Matrix4x4, MakeIdentity4x4, Multiply, etc.
//#include "Math/Vector.h"             // Vector3, Vector4
////#include "Camera/DebugCamera.h"      // DebugCamera
////#include "TextureHelper.h"           // CreateTextureResourceResolution, CreateTextureSRV
//#include "BufferHelper.h"            // CreateBufferResource（なければ後で差し替え）
//
...
//
//    MaterialData* materialDataSprite_ = nullptr;
